...
Source0  : https://downloads.xiph.org/releases/flac/flac-1.4.1.tar.xz
...
%prep
%setup -q -n flac-1.4.1
cd %{_builddir}/flac-1.4.1
pushd ..
cp -a flac-1.4.1 build32
popd
pushd ..
cp -a flac-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663888744
