...
%prep
%setup -q -n flac-1.3.4
cd %{_builddir}/flac-1.3.4
pushd ..
cp -a flac-1.3.4 build32
popd
pushd ..
cp -a flac-1.3.4 buildavx2
popd
pushd ..
cp -a flac-1.3.4 buildavx512
popd
...
cp %{_builddir}/flac-1.3.4/COPYING.GPL %{buildroot}/usr/share/package-licenses/flac/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/flac-1.3.4/COPYING.LGPL %{buildroot}/usr/share/package-licenses/flac/caeb68c46fa36651acf592771d09de7937926bb3
cp %{_builddir}/flac-1.3.4/COPYING.Xiph %{buildroot}/usr/share/package-licenses/flac/969c976617ec52d93cd04778e9613edb7b596a20
pushd ../build32/
%make_install32
