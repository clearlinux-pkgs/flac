...
Source0  : https://downloads.xiph.org/releases/flac/flac-1.4.0.tar.xz
...
%prep
%setup -q -n flac-1.4.0
cd %{_builddir}/flac-1.4.0
pushd ..
cp -a flac-1.4.0 build32
popd
pushd ..
cp -a flac-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662768720
