...
%prep
%setup -q -n flac-1.5.0
cd %{_builddir}/flac-1.5.0
pushd ..
cp -a flac-1.5.0 build32
popd
pushd ..
cp -a flac-1.5.0 buildavx2
popd
pushd ..
cp -a flac-1.5.0 buildavx512
popd
pushd ..
cp -a flac-1.5.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740077150
export GCC_IGNORE_WERROR=1
export AR=gcc-ar
export RANLIB=gcc-ranlib
export NM=gcc-nm
CLEAR_INTERMEDIATE_CFLAGS="$CLEAR_INTERMEDIATE_CFLAGS -O3 -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -fno-semantic-interposition -fstack-protector-strong -ftree-loop-vectorize -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
CLEAR_INTERMEDIATE_FCFLAGS="$CLEAR_INTERMEDIATE_FFLAGS -O3 -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -fno-semantic-interposition -fstack-protector-strong -ftree-loop-vectorize -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
CLEAR_INTERMEDIATE_FFLAGS="$CLEAR_INTERMEDIATE_FFLAGS -O3 -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -fno-semantic-interposition -fstack-protector-strong -ftree-loop-vectorize -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
CLEAR_INTERMEDIATE_CXXFLAGS="$CLEAR_INTERMEDIATE_CXXFLAGS -O3 -falign-functions=32 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -fno-semantic-interposition -fstack-protector-strong -ftree-loop-vectorize -fzero-call-used-regs=used -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
...
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS -march=x86-64-v3 "
%configure --host=x86_64-clr-linux-gnu --disable-static --enable-silent-rules \
--disable-valgrind-testing \
--disable-doxygen-docs \
--disable-xmms-plugin \
--disable-version-from-git
...
cp %{_builddir}/flac-%{version}/COPYING.Xiph %{buildroot}/usr/share/package-licenses/flac/121dfe8885cd91151f13badd466f7855311df796 || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libFLAC++.so.11.0.0
/V3/usr/lib64/libFLAC.so.14.0.0
/V4/usr/lib64/libFLAC++.so.11.0.0
/V4/usr/lib64/libFLAC.so.14.0.0
/VA/usr/lib64/libFLAC++.so.11.0.0
/VA/usr/lib64/libFLAC.so.14.0.0
/usr/lib64/libFLAC++.so.11
/usr/lib64/libFLAC++.so.11.0.0
/usr/lib64/libFLAC.so.14
/usr/lib64/libFLAC.so.14.0.0
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/flac/121dfe8885cd91151f13badd466f7855311df796
